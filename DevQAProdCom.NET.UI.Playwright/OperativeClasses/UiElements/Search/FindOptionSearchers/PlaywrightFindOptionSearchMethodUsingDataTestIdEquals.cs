...
{
    public class PlaywrightFindOptionSearchMethodUsingDataTestIdEquals : BasePlaywrightFindOptionSearchMethod
    {
        ...
        {
            return page.GetByTestId(findOption.Criteria);
        }
        ...
        {
            return previousElement.GetByTestId(findOption.Criteria);
        }
        ...
        {
            return previousFrameElement.GetByTestId(findOption.Criteria);
        }
        ...
        {
            return page.GetByTestId(findOption.Criteria).ContentFrame;
        }
        ...
        {
            return previousElement.GetByTestId(findOption.Criteria).ContentFrame;
        }
        ...
        {
            return previousFrameElement.GetByTestId(findOption.Criteria).ContentFrame;
        }
