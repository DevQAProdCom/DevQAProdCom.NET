...
{
    public class PlaywrightFindOptionSearchMethodUsingTitleContains : BasePlaywrightFindOptionSearchMethod
    {
        public override string Method => Use.TitleContains.ToString();

        #region Find List of Elements

        public override ILocator FindElementsFromBeginningOfDom(IPage page, IFindOption findOption)
        {
            return page.GetByTitle(findOption.Criteria);
        }
        ...
        {
            return previousElement.GetByTitle(findOption.Criteria);
        }
        ...
        {
            return previousFrameElement.GetByTitle(findOption.Criteria);
        }
        ...
        {
            return page.GetByTitle(findOption.Criteria).ContentFrame;
        }
        ...
        {
            return previousElement.GetByTitle(findOption.Criteria).ContentFrame;
        }
        ...
        {
            return previousFrameElement.GetByTitle(findOption.Criteria).ContentFrame;
        }
