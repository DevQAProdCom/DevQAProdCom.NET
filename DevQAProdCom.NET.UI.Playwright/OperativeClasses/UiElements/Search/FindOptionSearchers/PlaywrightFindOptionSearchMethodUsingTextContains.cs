...
{
    public class PlaywrightFindOptionSearchMethodUsingTextContains : BasePlaywrightFindOptionSearchMethod
    {
        ...
        {
            return page.GetByText(findOption.Criteria);
        }
        ...
        {
            return previousElement.GetByText(findOption.Criteria);
        }
        ...
        {
            return previousFrameElement.GetByText(findOption.Criteria);
        }
        ...
        {
            return page.GetByText(findOption.Criteria).ContentFrame;
        }
        ...
        {
            return previousElement.GetByText(findOption.Criteria).ContentFrame;
        }
        ...
        {
            return previousFrameElement.GetByText(findOption.Criteria).ContentFrame;
        }
