...
namespace ApplicationName.QA.TestsBasis.Ui.PageServices
{
    ...
    {
        public UiElementSearchRelativeToUiElementsListOfShadowRootHostComplexUiElementsAsClassTestPageService(IUiInteractor uiInteractor, string tabName = SharedUiConstants.DefaultTab) : base(uiInteractor, tabName)
        {
