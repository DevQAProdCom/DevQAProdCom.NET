...
namespace ApplicationName.QA.TestsBasis.Ui.PageServices
{
    ...
    {
        public UiElementSearchRelativeToBeginningOfPageTestPageService(IUiInteractor uiInteractor, string tabName = SharedUiConstants.DefaultTab) : base(uiInteractor, tabName)
        {
