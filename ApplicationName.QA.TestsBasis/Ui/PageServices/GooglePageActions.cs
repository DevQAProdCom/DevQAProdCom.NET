...
{
    public class GooglePageActions : SingleUiPageActions<GooglePage>
    {
        public GooglePageActions(IUiInteractor uiInteractor, string tabName = SharedUiConstants.DefaultUiInteractorTab) : base(uiInteractor, tabName)
        {
        }
