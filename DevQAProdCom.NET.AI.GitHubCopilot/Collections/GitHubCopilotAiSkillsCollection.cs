...
namespace DevQAProdCom.NET.AI.GitHubCopilot.Collections
{
    public class GitHubCopilotAiSkillsCollection : AiEntitiesCollection<GitHubCopilotAiSkillYamlConfigurationModel>
    {
        ...
        public GitHubCopilotAiSkillsCollection(ILogger logger, bool initializeFromDefaultLocations = true, string? collectionIdentifier = null, bool useExtendedSearch = false)
        ...
        public GitHubCopilotAiSkillsCollection(string baseFolder, ILogger logger, bool initializeFromDefaultLocations = true, string? collectionIdentifier = null, bool useExtendedSearch = false)
