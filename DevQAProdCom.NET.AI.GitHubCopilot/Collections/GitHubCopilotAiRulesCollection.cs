...
namespace DevQAProdCom.NET.AI.GitHubCopilot.Collections
{
    ...
    {
        public GitHubCopilotAiRulesCollection(ILogger logger, bool initializeWithDefaultLocations = true) : base(logger, initializeWithDefaultLocations: initializeWithDefaultLocations) { }

        public GitHubCopilotAiRulesCollection(string baseFolder, ILogger logger, bool initializeWithDefaultLocations = true) : base(baseFolder, logger, initializeWithDefaultLocations: initializeWithDefaultLocations) { }
