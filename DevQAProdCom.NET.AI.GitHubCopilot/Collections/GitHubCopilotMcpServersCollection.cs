...
namespace DevQAProdCom.NET.AI.GitHubCopilot.Collections
{
    ...
    {
        public GitHubCopilotMcpServersCollection(ILogger logger, bool initializeFromDefaultLocations = true, string? collectionIdentifier = null, bool useExtendedSearch = false) :
