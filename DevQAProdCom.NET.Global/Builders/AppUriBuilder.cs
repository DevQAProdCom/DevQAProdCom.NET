...
namespace DevQAProdCom.NET.Global.Builders
{
    public class AppUriBuilder
    {
        ...
        public AppUriBuilder WithPathParameters(params KeyValuePair<string, string>[] pathParameters)
        {
            _pathParameters ??= new Dictionary<string, string>();

            foreach (var parameter in pathParameters)
                _pathParameters.Upsert(parameter.Key, parameter.Value);
