...
namespace Tests.DevQAProdCom.NET.UI.Tests
{
    ...
    internal class Tests_UiElement_UsageCombinations : PerScenarioBaseTest
    {
        ...
        public void CUR_Should_Get_Table2_Row1_Cell_Text()
        {
            ...
            //WHEN
            var actualCellText = _testPage2Actions.Page.Table2.Rows.ElementAt(1).Cell.GetTextContent();
        ...
        public void Should_Get_Table2_Rows1_Cells1_Text()
        {
            ...
            //WHEN
            var actualCellText = _testPage2Actions.Page.Table2.Rows.ElementAt(1).Cells.ElementAt(1).GetTextContent();
        ...
        public void Should_Get_Table2_Rows_Select_Cells_Text()
        {
            ...
            //WHEN
            var actualCellsText = _testPage2Actions.Page.Table2.Rows.Select(x => x.Cell.GetTextContent()).ToList();
        ...
        public void Should_Get_Table2_Row1_Select_CellsText()
        {
            ...
            //WHEN
            var actualCellsText = _testPage2Actions.Page.Table2.Rows.ElementAt(1).Cells.Select(x => x.GetTextContent()).ToList();
        ...
        public void Should_Get_Table2_Rows_Select_Cells_Select_Text()
        {
            ...
            //WHEN
            var actualCellsText = _testPage2Actions.Page.Table2.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
        ...
        public void Should_Get_Row1_Select_CellsText()
        {
            ...
            //WHEN
            var actualCellsText = _testPage2Actions.Page.Rows.ElementAt(1).Cells.Select(x => x.GetTextContent()).ToList();
        ...
        public void Should_Get_Table3_Rows1_Cells1_UlList_Select_Text()
        {
            ...
            //WHEN
            var actualListText = _testPage2Actions.Page.Rows3!.ElementAt(1).Cells!.ElementAt(1).UlList!.Select(x => x.GetTextContent()).ToList();
        ...
        {
            //WHEN
            var actualButton0TextContent = _testPage2Actions.Page.TestListItems1[0].DivA.ButtonA.GetTextContent();
            var actualButton1TextContent = _testPage2Actions.Page.TestListItems1[1].DivA.ButtonA.GetTextContent();
        ...
        {
            //WHEN
            var actualText = _testPage2Actions.Page.TestListItems1.Select(x => x.DivA.ButtonA.GetTextContent()).ToList();
        ...
        {
            //WHEN
            var listCount = _testPage2Actions.Page.NotExistingInTheDomList.Count();
