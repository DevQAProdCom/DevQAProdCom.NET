...
namespace Tests.DevQAProdCom.NET.UI.Tests
{
    ...
    {
        private UiElementSearchRelativeToShadowRootHostComplexUiElementAsClassTestPageActions _pageActions;

        [OneTimeSetUp]
        public void OneTimeSetUp()
        {
            _pageActions = UiInteractor.Interact<UiElementSearchRelativeToShadowRootHostComplexUiElementAsClassTestPageActions>();
        }
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_5282.SimpleUiElementAsInterface_5282.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_8a39.ComplexUiElementAsClass_8a39.GetTextContent();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_ShadowRootHostComplexUiElementAsClass_UiElementsList_Of_SimpleUiElementsAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_3134.UiElementsListOfSimpleUiElementsAsInterface_4d30.Select(x => x.GetTextContent()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_ShadowRootHostComplexUiElementAsClass_UiElementsList_Of_ComplexUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_8c40.UiElementsListOfComplexUiElementsAsClass_43de.Select(x => x.GetTextContent()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_66c4.FrameSimpleUiElementAsInterface_66c4.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_ShadowRootHostComplexUiElementAsClass_UiElementsList_Of_FrameSimpleUiElementsAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_f789.UiElementsListOfFrameSimpleUiElementsAsInterface_f789.Select(x => x.GetIdAttribute()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_8d68.FrameComplexUiElementAsClass_8d68.FrameSimpleUiElementAsInterface_8d68.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_7fbe.ShadowRootHostSimpleUiElementAsInterface_7fbe.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_ShadowRootHostComplexUiElementAsClass_UiElementsList_Of_ShadowRootHostSimpleUiElementsAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_ba6b.UiElementsListOfShadowRootHostSimpleUiElementsAsInterface_ba6b.Select(x => x.GetIdAttribute()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_ShadowRootHostComplexUiElementAsClass_4e79.ShadowRootHostComplexUiElementAsClass_bb3d.ShadowRootHostSimpleUiElementAsInterface_bb3d.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
