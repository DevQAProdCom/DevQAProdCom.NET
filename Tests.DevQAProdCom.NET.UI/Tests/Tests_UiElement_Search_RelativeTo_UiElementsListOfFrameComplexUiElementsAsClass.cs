...
namespace Tests.DevQAProdCom.NET.UI.Tests
{
    ...
    {
        private UiElementSearchRelativeToUiElementsListOfFrameComplexUiElementsAsClassTestPageActions _pageActions;

        [OneTimeSetUp]
        public void OneTimeSetUp()
        {
            _pageActions = UiInteractor.Interact<UiElementSearchRelativeToUiElementsListOfFrameComplexUiElementsAsClassTestPageActions>();
        }
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_SimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_5d7b.Select(x => x.SimpleUiElementAsInterface_5d7b.GetTextContent()).ToList();
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_ComplexUiElementAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_5694.Select(x => x.ComplexUiElementAsClass_246f.GetTextContent()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_UiElementsList_Of_SimpleUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_473a
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_UiElementsList_Of_FrameComplexUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_5c57
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_FrameSimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_5d5a.Select(x => x.FrameSimpleUiElementAsInterface_5d5a.GetNonBooleanAttribute(Const.dataText)).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_UiElementsList_Of_Frame_SimpleUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_dd66
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_FrameComplexUiElementAsClass_FrameSimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_558a
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_ShadowRootHostSimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_4ffa.Select(x => x.ShadowRootHostSimpleUiElementAsInterface_4ffa.GetNonBooleanAttribute(Const.dataText)).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_UiElementsList_Of_ShadowRootHost_SimpleUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_93c7
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_FrameComplexUiElementsAsClass_ShadowRootHostComplexUiElementAsClass_ShadowRootHostSimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfFrameComplexUiElementsAsClass_76f1
