...
namespace Tests.DevQAProdCom.NET.UI.Tests
{
    ...
    internal class Tests_UiElement_Search_Frames : PerScenarioBaseTest
    {
        ...
        {
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualFrameButtonText = _framesTestPageActions.Page.ButtonInsideTopLevel0Frame.GetTextContent();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_FrameFindAttribute_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContent = _framesTestPageActions.Page.CellsInsideTopLevel0Frame.Select(x => x.GetTextContent()).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_FindAttributeWithElementInFrame_CollectionOfElements_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContent = _framesTestPageActions.Page.Table2InsideTopLevel0Frame.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_FrameAttribute_FindAttributeWithElementInFrame()
        {
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualFrameButtonText = _framesTestPageActions.Page.TopLevelFrame.ButtonFrameInsideFrame.GetTextContent();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_FrameAttribute_Element()
        {
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualFrameButtonText = _framesTestPageActions.Page.TopLevelFrame.ButtonInsideTopLevel0Frame.GetTextContent();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_FrameAttribute_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContent = _framesTestPageActions.Page.TopLevelFrame.Cells.Select(x => x.GetTextContent()).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_FrameAttribute_Element_CollectionOfElements_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContent = _framesTestPageActions.Page.TopLevelFrame.Table2.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_FrameAttribute_FrameAttribute_Element()
        {
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualFrameButtonText = _framesTestPageActions.Page.TopLevelFrame.FrameInsideFrame.ButtonFrameInsideFrame.GetTextContent();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_2_Consequent_Interactions_A_Page_FrameAttribute_FrameAttribute_CollectionOfElements_CollectionOfElements_B_Page_FrameAttribute_Element_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContentOfFrameInsideFrameTable = _framesTestPageActions.Page.TopLevelFrame.FrameInsideFrame.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualTextContentOfTopLevelFrameTable = _framesTestPageActions.Page.TopLevelFrame.Table2.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_2_Consequent_Interactions_A_Page_FrameAttribute_FrameAttribute_Element_CollectionOfElements_CollectionOfElements_B_Page_FrameAttribute_Element_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContentOfFrameInsideFrameTable = _framesTestPageActions.Page.TopLevelFrame.FrameInsideFrame.Table2.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualTextContentOfTopLevelFrameTable = _framesTestPageActions.Page.TopLevelFrame.Table2.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_Element_FrameAttribute_Element()
        {
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualFrameButtonText = _framesTestPageActions.Page.TableWithCellsWithFrames.TopLevelFrame.ButtonInsideTopLevel0Frame.GetTextContent();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_Element_FrameAttribute_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContent = _framesTestPageActions.Page.TableWithCellsWithFrames.TopLevelFrame.Cells.Select(x => x.GetTextContent()).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_Element_FrameAttribute_Element_CollectionOfElements_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContent = _framesTestPageActions.Page.TableWithCellsWithFrames.TopLevelFrame.Table2.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_Element_FrameAttribute_FrameAttribute_Element()
        {
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualFrameButtonText = _framesTestPageActions.Page.TableWithCellsWithFrames.TopLevelFrame.FrameInsideFrame.ButtonFrameInsideFrame.GetTextContent();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_2_Consequent_Interactions_A_Page_Element_FrameAttribute_FrameAttribute_CollectionOfElements_CollectionOfElements_B_Page_FrameAttribute_Element_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContentOfFrameInsideFrameTable = _framesTestPageActions.Page.TableWithCellsWithFrames.TopLevelFrame.FrameInsideFrame.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualTextContentOfTopLevelFrameTable = _framesTestPageActions.Page.TopLevelFrame.Table2.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_2_Consequent_Interactions_A_Page_Element_FrameAttribute_FrameAttribute_Element_CollectionOfElements_CollectionOfElements_B_Page_FrameAttribute_Element_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContentOfFrameInsideFrameTable = _framesTestPageActions.Page.TableWithCellsWithFrames.TopLevelFrame.FrameInsideFrame.Table2.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualTextContentOfTopLevelFrameTable = _framesTestPageActions.Page.TopLevelFrame.Table2.Rows.SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_Element_CollectionOfElementsIndex_CollectionOfElementsIndex_FrameAttribute_Element()
        {
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualFrameButtonText = _framesTestPageActions.Page.TableWithCellsWithFrames.RowsWithCellsWithFrames[1].CellsWithFrames[1].TopLevelFrame.ButtonInsideTopLevel0Frame.GetTextContent();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_CollectionOfElementsWithFramesAttributes_Element()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContent = _framesTestPageActions.Page.TopLevelFramesList.Select(x => x.ButtonInsideTopLevel0Frame.GetTextContent()).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_CollectionOfElementsWithFramesAttributes_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContent = _framesTestPageActions.Page.TopLevelFramesList.SelectMany(x => x.Cells).Select(x => x.GetTextContent()).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
        ...
        public void Should_Support_Interaction_Page_CollectionOfElementsWithFramesAttributes_Element_CollectionOfElements_CollectionOfElements()
        {
            ...
            //WHEN
            var actualNonFrameButtonTextBeforeInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
            var actualTextContent = _framesTestPageActions.Page.TopLevelFramesList.Select(x => x.Table2).SelectMany(x => x.Rows).SelectMany(x => x.Cells.Select(y => y.GetTextContent())).ToList();
            var actualNonFrameButtonTextAfterInteractionWithFrame = _framesTestPageActions.Page.ButtonNotInFrame.GetTextContent();
