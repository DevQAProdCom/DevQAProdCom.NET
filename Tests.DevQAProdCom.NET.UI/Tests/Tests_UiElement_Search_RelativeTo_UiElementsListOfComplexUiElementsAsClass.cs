...
namespace Tests.DevQAProdCom.NET.UI.Tests
{
    ...
    {
        private UiElementSearchRelativeToUiElementsListOfComplexUiElementsAsClassTestPageActions _pageActions;

        [OneTimeSetUp]
        public void OneTimeSetUp()
        {
            _pageActions = UiInteractor.Interact<UiElementSearchRelativeToUiElementsListOfComplexUiElementsAsClassTestPageActions>();
        }
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_SimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_8921.Select(x => x.SimpleUiElementAsInterface_8921.GetTextContent()).ToList();
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_ComplexUiElementAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_8e8c.Select(x => x.ComplexUiElementAsClass_d543.GetTextContent()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_UiElementsList_Of_SimpleUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_79c4
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_UiElementsList_Of_ComplexUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_c0d6
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_FrameSimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_4596.Select(x => x.FrameSimpleUiElementAsInterface_4596.GetNonBooleanAttribute(Const.dataText)).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_UiElementsList_Of_Frame_SimpleUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_9240
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_FrameComplexUiElementAsClass_FrameSimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_68b1
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_ShadowRootHostSimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_52fa.Select(x => x.ShadowRootHostSimpleUiElementAsInterface_52fa.GetNonBooleanAttribute(Const.dataText)).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_UiElementsList_Of_ShadowRootHost_SimpleUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_d413
        ...
        public void Should_Support_Search_Page_UiElementsList_Of_ComplexUiElementsAsClass_ShadowRootHostComplexUiElementAsClass_ShadowRootHostSimpleUiElementAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_UiElementsListOfComplexUiElementsAsClass_49e5
