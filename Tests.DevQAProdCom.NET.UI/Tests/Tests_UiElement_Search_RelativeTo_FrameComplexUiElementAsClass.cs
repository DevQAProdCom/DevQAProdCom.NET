...
namespace Tests.DevQAProdCom.NET.UI.Tests
{
    ...
    {
        private UiElementSearchRelativeToFrameComplexUiElementAsClassTestPageActions _pageActions;

        [OneTimeSetUp]
        public void OneTimeSetUp()
        {
            _pageActions = UiInteractor.Interact<UiElementSearchRelativeToFrameComplexUiElementAsClassTestPageActions>();
        }
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_FrameComplexUiElementAsClass_965d.SimpleUiElementAsInterface_965d.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_FrameComplexUiElementAsClass_c39d.ComplexUiElementAsClass_c39d.GetTextContent();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_FrameComplexUiElementAsClass_UiElementsList_Of_SimpleUiElementsAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_FrameComplexUiElementAsClass_7c15.UiElementsListOfSimpleUiElementsAsInterface_6399.Select(x => x.GetTextContent()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_FrameComplexUiElementAsClass_UiElementsList_Of_ComplexUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_FrameComplexUiElementAsClass_b0fc.UiElementsListOfComplexUiElementsAsClass_47fa.Select(x => x.GetTextContent()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_FrameComplexUiElementAsClass_b152.FrameSimpleUiElementAsInterface_b152.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_FrameComplexUiElementAsClass_UiElementsList_Of_FrameSimpleUiElementsAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_FrameComplexUiElementAsClass_50c2.UiElementsListOfFrameSimpleUiElementsAsInterface_50c2.Select(x => x.GetIdAttribute()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_FrameComplexUiElementAsClass_e77c.FrameComplexUiElementAsClass_7116.FrameSimpleUiElementAsInterface_7116.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_FrameComplexUiElementAsClass_d481.ShadowRootHostSimpleUiElementAsInterface_d481.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_FrameComplexUiElementAsClass_UiElementsList_Of_ShadowRootHostSimpleUiElementsAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions.Page.Page_FrameComplexUiElementAsClass_b37b.UiElementsListOfShadowRootHostSimpleUiElementsAsInterface_b37b.Select(x => x.GetIdAttribute()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions.Page.Page_FrameComplexUiElementAsClass_8acd.ShadowRootHostComplexUiElementAsClass_8acd.ShadowRootHostSimpleUiElementAsInterface_8acd.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions.Page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
