...
namespace Tests.DevQAProdCom.NET.UI.Tests
{
    ...
    internal class Tests_UiElement_Search_RelativeTo_ComplexUiElementAsClass : PerFeatureBaseTest
    {
        ...
        {
            //WHEN
            var actualValue = _pageActions._page.Page_ComplexUiElementAsClass_86ea.SimpleUiElementAsInterface_86ea.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions._page.Page_ComplexUiElementAsClass_0d51.ComplexUiElementAsClass_fd65.GetTextContent();
            var actualTopLevelUiElementTextContent = _pageActions._page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_ComplexUiElementAsClass_UiElementsList_Of_SimpleUiElementsAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions._page.Page_ComplexUiElementAsClass_576e.UiElementsListOfSimpleUiElementsAsInterface_e141.Select(x => x.GetTextContent()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions._page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_ComplexUiElementAsClass_UiElementsList_Of_ComplexUiElementsAsClass()
        {
            ...
            //WHEN
            var actualValues = _pageActions._page.Page_ComplexUiElementAsClass_44a5.UiElementsListOfComplexUiElementsAsClass_b0d2.Select(x => x.GetTextContent()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions._page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions._page.Page_ComplexUiElementAsClass_cd75.FrameSimpleUiElementAsInterface_cd75.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions._page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_ComplexUiElementAsClass_UiElementsList_Of_FrameSimpleUiElementsAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions._page.Page_ComplexUiElementAsClass_030a.UiElementsListOfFrameSimpleUiElementsAsInterface_030a.Select(x => x.GetIdAttribute()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions._page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions._page.Page_ComplexUiElementAsClass_5905.FrameComplexUiElementAsClass_5905.FrameSimpleUiElementAsInterface_5905.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions._page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions._page.Page_ComplexUiElementAsClass_7275.ShadowRootHostSimpleUiElementAsInterface_7275.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions._page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        public void Should_Support_SearchPage_ComplexUiElementAsClass_UiElementsList_Of_ShadowRootHostSimpleUiElementsAsInterface()
        {
            ...
            //WHEN
            var actualValues = _pageActions._page.Page_ComplexUiElementAsClass_8939.UiElementsListOfShadowRootHostSimpleUiElementsAsInterface_8939.Select(x => x.GetIdAttribute()).ToList();
            var actualTopLevelUiElementTextContent = _pageActions._page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
        ...
        {
            //WHEN
            var actualValue = _pageActions._page.Page_ComplexUiElementAsClass_4f49.ShadowRootHostComplexUiElementAsClass_4f49.ShadowRootHostSimpleUiElementAsInterface_4f49.GetIdAttribute();
            var actualTopLevelUiElementTextContent = _pageActions._page.Page_TopLevelSimpleUiElementAsInterface.GetTextContent();
